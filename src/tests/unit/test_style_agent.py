...
@pytest.fixture
def standard_input(video_input_fixture, story_fixture, concept_direction_fixture):
    return StyleInput(
        idea=video_input_fixture,
        story_concept=story_fixture,
        concept_direction=concept_direction_fixture
    )
...
def test_story_agent_live(standard_input):
    ...
    # shape
    assert isinstance(result, StyleOutput)